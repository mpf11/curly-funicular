...
//
// Debug builds are a no-op: we don't want `cargo run` to hit GitHub or to
// clobber target/debug/wheel_switcher.exe with the release binary.

#[cfg(debug_assertions)]
pub fn spawn_background_check() {}

#[cfg(not(debug_assertions))]
pub use release::spawn_background_check;
